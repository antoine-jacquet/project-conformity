...
png("~/Documents/GitHub/project-conformity/Fig1/fig1a.png")
...
png("~/Documents/GitHub/project-conformity/Fig1/fig1b.png")
...
png("~/Documents/GitHub/project-conformity/Fig1/fig1.png", width=2*2*480, height=2*480)
